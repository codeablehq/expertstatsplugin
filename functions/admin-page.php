        ...
        <form method="get" id="date_form" data-start-year="<?php echo $first_year; ?>" data-end-year="<?php echo $last_year; ?>">
            <input type="hidden" name="page" value="codeable_transcactions_stats" />
                ...
                <div class="section">
                    ...
                    <?php echo __('Months', 'wpcable'); ?>&nbsp;<input type="radio" name="chart_display_method" value="months" <?php echo ($chart_display_method == 'months' ? 'checked="checked"' : ''); ?> />
                    <?php echo __('Days', 'wpcable'); ?>&nbsp;<input type="radio" name="chart_display_method" value="days" <?php echo ($chart_display_method == 'days' ? 'checked="checked"' : ''); ?> />
                </div>
